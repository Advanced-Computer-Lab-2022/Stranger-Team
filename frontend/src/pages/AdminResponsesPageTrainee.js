...
//         const response = await fetch(`/checkIfAdminRespondedTrainee/?ReportId=${reportId}`)
...
//                 window.location.href=`/AdminResponseCurrentReportPageTrainee?ReportId=${problem._id}`}}
//                 key={problem._id}>
