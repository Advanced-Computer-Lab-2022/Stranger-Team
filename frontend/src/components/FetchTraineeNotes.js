...
const TraineeViewWithNotes = () => {
    ...
    const response = await fetch(`/fetchCorporateTraineeNotes/?CorporateTraineeId=${CorporateTraineeId}&SubtitleId=${SubtitleId}`)
    ...
    const routeChange = () =>{ 
    let path = `/fetchCorporateTraineeAddNotes/?CorporateTraineeId=${CorporateTraineeId}`; 
    navigate(path);
}
return (
