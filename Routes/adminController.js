    ...
    const refund=require('../Models/RequestRefund')
...
//View Refund Requests
    const viewRefund=async(req,res)=>{
        ...
        try{
        const amount= await course.findById({_id:courseId},{Price:1,_id:0})
        
        const req=await refund.create({"Trainee_Id":traineeId,"CourseId":courseId,"RefundStatus":"Pending","Amount":amount.Price})
    ...
    module.exports = {addAdmin, addCorporateTrainee, viewPendingInstructors, registerPendingInstructor, addInstructor, deletePendingInstructor, viewAdmins, deleteAdmin, viewInstructors,
         deleteInstructor, viewCT, deleteCT, updateAdmin, updateInstructor,
          updateCT, addPendingInstructor,viewRefund}