    ...
    const Wallet=require("../Models/TraineeWalletScheema");
const Traineewallet = require("../Models/TraineeWalletScheema");
...
try{
    ...
    module.exports ={addIndividualTrainee,indiviualTraineeRegisterCourse,
        viewMyRegisteredCourses,traineeSendReport,
        fetchTraineeAllPreviousReports,getWalletBalance};
