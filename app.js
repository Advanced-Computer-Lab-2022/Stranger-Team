...
const {View_All_Courses, Filter_By_Subject, Filter_By_Rate, Filter_By_Price,data,createCourse,Search_By_Title,Search_By_Instructor_Name,Filter_By_Subject_And_Price,Filter_By_Subject_And_Rating,Filter_By_Subject_And_Rating_And_Price,viewMyInstructorCoursesById,getCurrentCourseDetails,getCurrentCourseInformation,addCourseDiscount,fetchCourseDiscountsByCourseId,addSubtitle,fetchSubtitlesByCourseId,fetchInstructorById,fetchCoursePreviewLink,addANewInstructor,getCurrentCourseInstructor,fetchCurrentCourseInstructorByInstructorId,
  fetchCurrentCourseInstructorCoursesByInstructorId,ratingACourse,fetchTheSubtitleBySubtitleId,
  getNumberofSubtitlies,UpdateProgressOfSubtitlie,postMethod,getStatusOfSubtitlie} = require('./Routes/coursesController');
...
const {addAdmin, addCorporateTrainee, viewPendingInstructors,
   registerPendingInstructor, addInstructor, 
   deletePendingInstructor, viewAdmins, deleteAdmin, 
   viewInstructors, deleteInstructor, viewCT, deleteCT, updateAdmin,
   updateInstructor, updateCT, addPendingInstructor,viewRefund} = require('./Routes/adminController');
...
const {corporateTraineeSendReport,fetchCorporateTraineeAllPreviousReports,
  corporateViewMyRegisteredCourses,corporateTraineeRegisterCourse,AddNotes,getNotes} = require('./Routes/corporateTraineeController');
...
//app.get("/corporateTraineeUpdate",updateProgress);
...
app.get("/getSubtitlesCount",getNumberofSubtitlies);
...
app.get('/adminViewRefunds',viewRefund)